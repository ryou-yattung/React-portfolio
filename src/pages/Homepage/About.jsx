          ...
          <div className="absolute left-4 sm:static sm:ml-16 text-ftcolor 2xl:flex 2xl:justify-start">
            ...
            <div className="hidden sm:block 2xl:ml-8">
              ...
              <p className="text-txf w-[400px]">
                常に新しいことに挑戦する。新しいことに直面し乗り越えることで、新しいスキルを身につけ、自分の限界も超える気がします。例えば初めて自分のサイトを作るとき、本当に出来るのか不安に感じました。サイトが完成した時、私が思っている想像より良く出来た時、自分の限界を超えた気がします。この達成感は私を成長に繋げ、人生の軸においています。
              </p>
            </div>
          </div>
        </div>
