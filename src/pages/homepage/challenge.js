...
const challenge = () => {
  return (
    <section className="relative z-10 w-full h-auto sm:pb-16 sm:h-auto sm:ml-[30px] pt-10 sm:pt-32 bg-bgcolor2">
      ...
      <div className="flex justify-around align-center flex-wrap sm:flex-nowrap overflow-scroll">
        <div className="text-center w-[400px] px-8 sm:px-3 mb-16">
          <h3 className="text-txt sm:text-txts">ゲンゴ</h3>
          <h4 className="text-txf text-[#71613f] font-bold mb-8">LANGUAGE</h4>
          <img src={Book} alt="book" className="w-[120px] m-auto mb-8" />
        ...
        <div className="text-center w-[400px] px-7 mb-16">
